# Workspace Policy: portal (jesuscolin)
...
*   **Project Background:** (Update this with the high-level context of what is being built or solved in this workspace)
...
*   **Primary Languages:** (e.g., C++, Python, Go)
*   **Build/Package System:** (e.g., Blaze, npm, pip)
*   **Critical Context Paths:**
    *   (e.g., //depot/google3/analysis/dremel/core/ml/...)
*   **Core Dependencies:** (List libraries as discovered: e.g., Absl, Protobuf, gRPC)
